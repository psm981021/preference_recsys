...
class ClusteredAttention(Module):
    ...
    ---------
        ...
        event_dispatcher: str or EventDispatcher instance to be used by this
                          ...
                          global dispatcher)
    """
    def __init__(self,args, clusters, iterations=10, bits=32,
                 hash_bias=True, softmax_temp=None, attention_dropout=0.1,
                 event_dispatcher=""):
        super(ClusteredAttention, self).__init__()
        self. args = args
        self.clusters = args.cluster_num #clusters
    ...
    def forward(self, queries, keys, values, attn_mask, query_lengths,
        ...
        groups, sorted_indx = self._create_query_groups(queries, query_lengths,args)
